  ...
  return (
    <div className="bg-[url('https://zamontour.uz/assets/images/heading-bg-02.jpg')] bg-no-repeat bg-center bg-cover pt-[260px] pb-[190px] text-center">
      <div className="max-w-7xl mx-auto px-3 relative">
        <h4 className="text-5 font-medium text-white text-[15px] mb-[15px] pb-[65px] relative after:absolute after:w-[100px] h-[2px] after:bg-[rgba(250, 250, 250, 0.3] after:content-[''] after:left-[50%] after:bottom-0 after:transform after:translate-y-[-50px]">
          {t("Book Preferred Deal Here")}
        </h4>
        <div className="absolute w-[100px] h-[2px] bg-[#fafafa4c] left-[50%] top-[50px] transform translate-x-[-50%]" />
        <h2 className="text-[35px] md:text-[50px] font-bold text-white mb-[30px]">
